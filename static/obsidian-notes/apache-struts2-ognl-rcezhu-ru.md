...
halo:
  ...
  name: b828374f-78c3-4f75-a709-8a3b8b17d884
  publish: true
---
...
访问：http://靶机IP:8080
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116153643875.png)
...
```
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116154120948.png)
成功将id的值更换执行
...
```
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116154307914.png)
成功读取`/etc/passwd`
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116154354648.png)
...
nc -lvvp 4444 启动监听
```
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116154843948.png)
发送payload
```
...
```
成功上线:
![image.png](https://cdn.jsdmirror.com/gh/hzhsec/upload@main/20260116154954834.png)
